...
public class SimpleValueConverter
{
	...
	static
	{
		...
		supportedTypes.put(boolean.class, new BooleanConverter());
		supportedTypes.put(Boolean.class, new BooleanConverter());
		...
		supportedTypes.put(Date.class, new DateConverter());
		
		supportedTypes.put(Locale.class, new LocaleConverter());
		supportedTypes.put(Key.class, new KeyConverter());
		supportedTypes.put(DBRef.class, new DBRefConverter());
	...
	public static Object objectFromValue(final Class javaType, final Object val)
	{
	...
	public static boolean compatibleTypes(final Class type1, final Class type2)
	{
		...
		return (type1.isAssignableFrom(type2) || ((type1.isPrimitive() || type2.isPrimitive()) && type2.getSimpleName()
				.toLowerCase().equals(type1.getSimpleName().toLowerCase())));// &&
	...
	/** Converts known types from mongodb -> java. */
	public static Object objectFromValue(final Class javaType, final BasicDBObject dbObject, final String name)
	{
